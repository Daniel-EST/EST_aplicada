...
base_2000 <- mutate(base_2000,`Esperança de vida ao nascer 2000` = padronizar(`Esperança de vida ao nascer 2000`),
                    `Mortalidade infantil 2000` = 1 - padronizar(`Mortalidade infantil 2000`),
                    `Taxa de analfabetismo - 15 anos ou mais 2000` = 1 - padronizar(`Taxa de analfabetismo - 15 anos ou mais 2000`),
                    `% de pobres 2000` = 1 - padronizar(`% de pobres 2000`),
                    `% de vulneráveis à pobreza 2000` = 1 - padronizar(`% de vulneráveis à pobreza 2000`),
                    `IDHM 2000` = padronizar(`IDHM 2000`)) ; head(base_2000,4)

base_2010 <- mutate(base_2010,`Esperança de vida ao nascer 2010` = padronizar(`Esperança de vida ao nascer 2010`),
                    `Mortalidade infantil 2010` = 1 - padronizar(`Mortalidade infantil 2010`),
                    `Taxa de analfabetismo - 15 anos ou mais 2010` = 1 - padronizar(`Taxa de analfabetismo - 15 anos ou mais 2010`),
                    `% de pobres 2010` = 1 - padronizar(`% de pobres 2010`),
                    `% de vulneráveis à pobreza 2010` = 1 - padronizar(`% de vulneráveis à pobreza 2010`),
...
plot(base_2000$Indicador_final, base_2000$`IDHM 2000`)
