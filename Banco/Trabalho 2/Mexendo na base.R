...
write.csv2(mat_cor_2000,"Banco/Trabalho 2/Matriz Correlação 2000.csv",row.names=FALSE)
write.csv2(mat_cov_2000,"Banco/Trabalho 2/Matriz Covariancia 2000.csv",row.names=FALSE)

write.csv2(mat_cor_2010,"Banco/Trabalho 2/Matriz Correlação 2010.csv",row.names=FALSE)
write.csv2(mat_cov_2010,"Banco/Trabalho 2/Matriz Covariancia 2010.csv",row.names=FALSE)
...
saveRDS(base2, "Banco/Trabalho 2/Base_sem_na.rds")
