...
![Número de clientes por banco](pictograma.png){ width=300px }

![Número de clientes por banco](QQ Plot idade genero.jpeg){ width=300px }
![Número de clientes por banco](QQplot Idade x Lim.jpeg){ width=300px }

![Número de clientes por banco](QQ Plot idade genero.jpeg){ width=300px }
![Número de clientes por banco](Nome no SERASA por sexo.jpeg){ width=300px }

![Número de clientes por banco](Estado civil por Sexo.jpeg){ width=300px }
![Número de clientes por banco](Entedimento do Layout.jpeg){ width=300px }

![Número de clientes por banco](Gerente Satisfacao.jpeg){ width=300px }
